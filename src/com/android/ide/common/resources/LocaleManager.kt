...
object LocaleManager {
     ...
     */
    @Nullable
    fun getLanguageRegion(@NonNull languageCode: String): String? {
     ...
     */
    private fun getTimeZoneRegionAlpha2(@NonNull zone: TimeZone): String? {
     ...
     */
    private fun getDefaultLanguageRegion(@NonNull languageCode: String): String? {
    ...
    @NonNull
    fun getRelevantRegions(@NonNull languageCode: String): List<String> {
    ...
    private fun getDisambiguateRegions(@NonNull languageCode: String): List<String>? {
     ...
     * null if not known
     */
    fun getLanguageName(@NonNull languageCode: String): String? {
        if (languageCode.length == 2) {
            assert(Character.isLowerCase(languageCode[0]) && Character.isLowerCase(languageCode[1])) { languageCode }
            val index = Arrays.binarySearch(ISO_639_1_CODES, languageCode)
     ...
     * null if not known
     */
    fun getRegionName(@NonNull regionCode: String): String? {
    ...
    private fun getTimeZoneRegionIndex(@NonNull zone: TimeZone): Int {
