...
object LocaleManager {
    ...
    private fun getDefaultLanguageRegion(@NotNull languageCode: String): String? {
        if (languageCode.length == 2) {
            ...
            assert(
                Character.isLowerCase(languageCode[0])
                        && Character.isLowerCase(languageCode[1])
                        && Character.isLowerCase(languageCode[2])
            ) { languageCode }
    ...
    fun getRegionName(@NotNull regionCode: String): String? {
        if (regionCode.length == 2) {
            ...
            assert(
                Character.isUpperCase(regionCode[0])
                        && Character.isUpperCase(regionCode[1])
                        && Character.isUpperCase(regionCode[2])
            ) { regionCode }
    ...
    private val ISO_639_2_CODES = arrayOf(
        "aar", "abk", "ace", "ach", "ada", "ady", "afa", "afh", "afr", "agq", "ain",
    ...
    private val ISO_639_2_NAMES = arrayOf(
        "Afar", // Code aar/aa
    ...
    private val ISO_639_1_CODES = arrayOf(
    ...
    private val ISO_639_1_TO_2 = intArrayOf(
        0, 1, 33, 8, 11, 16, 22, 20, 28, 32, 35, 36, 39, 46, 66, 52, 55, 41, 48, 58,
    ...
    private val ISO_639_2_TO_1 = intArrayOf(
        0, 1, -1, -1, -1, -1, -1, -1, 3, -1, -1, 4, -1, -1, -1, -1, 5, -1, -1, -1,
    ...
    private val ISO_3166_2_CODES = arrayOf(
    ...
    private val ISO_3166_2_NAMES = arrayOf(
        "Aruba", // Code ABW/AW
    ...
    private val ISO_3166_1_CODES = arrayOf(
    ...
    private val ISO_3166_1_TO_2 = intArrayOf(
        6, 7, 1, 13, 3, 5, 9, 2, 11, 8, 10, 15, 14, 0, 4, 16, 26, 33, 22, 18, 21,
    ...
    private val ISO_3166_2_TO_1 = intArrayOf(
        13, 2, 7, 4, 14, 5, 0, 1, 9, 6, 10, 8, 215, 3, 12, 11, 15, 23, 19, 24, 29,
    ...
    private val REGIONS_ARA = intArrayOf(
        7, 24, 50, 60, 64, 66, 67, 68, 108, 110, 114, 123, 125, 127, 137, 152, 171,
    ...
    private val REGIONS_ENG = intArrayOf(
        234, 3, 10, 13, 14, 18, 25, 29, 30, 33, 37, 39, 40, 45, 48, 55, 56, 61, 67, 73,
    ...
    private val REGIONS_FRA = intArrayOf(
        75, 17, 18, 19, 21, 27, 38, 39, 41, 44, 45, 46, 47, 50, 60, 64, 78, 84, 85, 88,
    ...
    private val REGIONS_SPA = intArrayOf(
        69, 8, 31, 42, 49, 52, 53, 63, 65, 88, 92, 98, 142, 164, 173, 175, 176, 180,
        183, 200, 233, 234, 238
    )
    ...
    private val LANGUAGE_REGIONS = arrayOf(
        null, null, null, null, null, null, null, null, REGIONS_AFR, null, null,
        null,
    ...
    private val LANGUAGE_REGION = intArrayOf(
        71, 80, -1, -1, -1, -1, -1, -1, 246, 45, -1, 82, -1, -1, -1, -1, 71, -1,
        -1,
