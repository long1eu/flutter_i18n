...
object I18nFile {
    ...
    fun generate(project: Project, valuesFolder: VirtualFile) {
        ...
        runWriteAction {
            ...
            if (children.isEmpty()) children.add(createStringsFile("en", valuesFolder, documentManager, psiManager))
            ...
            generateSClass(map, fileBuilder)

            //
            map.keys.forEach {
                fileBuilder.append("// ignore: camel_case_types\n")
    ...
    private fun generateSClass(map: HashMap<String, HashMap<String, String>>, fileBuilder: StringBuilder): StringBuilder {
        val mapEn = map["en"]!!
    ...
    private fun generateLangClass(lang: String, map: HashMap<String, HashMap<String, String>>,
                                  fileBuilder: StringBuilder): StringBuilder {
    ...
    private fun generateDelegateClass(map: HashMap<String, HashMap<String, String>>, fileBuilder: StringBuilder): java.lang.StringBuilder? {
        ...
        map.keys.forEach { fileBuilder.append("      case \"$it\":\n        return new SynchronousFuture<S>(new $it(locale));\n") }
        return fileBuilder.append(delegateClassEnd)
    }


    private fun getStrings(id: String, mapLang: HashMap<String, String>, fileBuilder: StringBuilder, isOverride: Boolean = true) {
        val value = mapLang[id]!!
        if (isOverride) fileBuilder.append("  @override\n")
        fileBuilder.append("  String get $id => \"$value\";\n")
    }

    private fun getParametrized(id: String, mapLang: HashMap<String, String>, fileBuilder: StringBuilder, isOverride: Boolean = true) {
        val value = mapLang[id]!!
    ...
    private fun getPlurals(id: String, pluralsMaps: HashMap<String, ArrayList<String>>, mapLang: HashMap<String, String>,
    ...
    private fun getI18nFile(project: Project): VirtualFile {
